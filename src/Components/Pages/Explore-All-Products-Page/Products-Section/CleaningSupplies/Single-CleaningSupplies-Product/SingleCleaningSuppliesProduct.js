...
const SingleCleaningSuppliesProduct = (props) => {
    const { name, image, weight, price } = props.singleCleaningSuppliesProduct;
    return (
        <div>
...
export default SingleCleaningSuppliesProduct;