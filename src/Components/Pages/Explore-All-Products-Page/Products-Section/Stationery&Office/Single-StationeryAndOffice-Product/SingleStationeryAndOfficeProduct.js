...
const SingleStationeryAndOfficeProduct = (props) => {
    const { name, image, weight, price } = props.singleStationeryAndOfficeProduct;
    return (
        <div>
...
export default SingleStationeryAndOfficeProduct;